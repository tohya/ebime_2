...
(function() {
  $(function() {
    var speed;
    speed = 200;
    return $('#slider').mousewheel(function(event, mov) {
...
(function() {
  $(function() {
    ...
    return $('#jissekis #door').width(size * width);
  });

  $(function() {
    return $('.time-list button').click(function() {
      var parent, tllr;
      alert($('.time-list button').index(this));
      tllr = 2 * $('.tll').length / $('.date').length;
      alert($('.time-list button').index(this) / tllr);
      alert($('.time-list button').index(this) % tllr);
      return parent = $('.time-list button').parent().parent();
    });
  });
...
(function() {
  $(function() {
    ...
    return $('#kintais #door').width(size * width);
  });
